    ...
    return (
        <div className='flex flex-col gap-8 m-5 max-w-7xl animate-fade-in-up font-outfit'>
            ...
            <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-6'>
                <div>
                    <h1 className='text-4xl font-black text-gray-900 dark:text-white tracking-tight'>Reputation & Trust</h1>
                    <p className='text-gray-500 dark:text-gray-400 mt-2 text-lg italic'>Monitor patient satisfaction and professional feedback pulse.</p>
                ...
                <div className='flex items-center gap-3'>
                    <div className='flex items-center gap-3 bg-white dark:bg-gray-800 px-6 py-3 rounded-2xl shadow-soft border border-gray-100'>
                        <div className='w-3 h-3 bg-amber-400 rounded-full animate-pulse'></div>
                        <span className='text-xs font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest'>Verified Professional Profile</span>
                    </div>
                    <button
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
                {/* Avg Rating Card */}
                <div className='bg-white dark:bg-gray-800 p-10 rounded-[3rem] shadow-card border border-gray-100 flex flex-col items-center justify-center relative overflow-hidden group hover:-translate-y-2 transition-all duration-500'>
                    ...
                    <div className='relative z-10 flex items-end gap-2 mb-4'>
                        <h2 className='text-7xl font-black text-gray-900 dark:text-white leading-none'>{stats.avg}</h2>
                ...
                <div className='bg-white dark:bg-gray-800 p-10 rounded-[3rem] shadow-card border border-gray-100 flex flex-col justify-center hover:-translate-y-2 transition-all duration-500'>
                    <p className='text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-4'>Critical Feedback</p>
                    <h2 className='text-5xl font-black text-gray-900 dark:text-white leading-none'>{stats.lowRatings}</h2>
                    <p className='text-xs font-bold text-gray-500 dark:text-gray-400 mt-3'>Reviews with 1-2 stars that may need follow-up.</p>
                </div>

                {/* Satisfaction Breakdown */}
                <div className='md:col-span-2 bg-white dark:bg-gray-800 p-10 rounded-[3rem] shadow-medical border border-gray-100'>
                    <div className='flex justify-between items-center mb-10'>
                        <h3 className='text-xl font-black text-gray-900 dark:text-white tracking-tight'>Satisfaction Distribution</h3>
                            ...
                            return (
                                <div key={star} className='flex items-center gap-6 group'>
                                    <div className='flex items-center gap-2 min-w-[80px]'>
                                        <span className='text-xs font-black text-gray-500 dark:text-gray-400'>{star}</span>
                                    ...
                                    <div className='flex-1 h-3 bg-gray-50 dark:bg-gray-900 rounded-full overflow-hidden relative'>
                                        <div
                                    ...
                                    <div className='min-w-[40px] text-right'>
                                        <span className='text-xs font-black text-gray-400 group-hover:text-gray-900 dark:text-white transition-colors'>{count}</span>
                                    </div>
                                </div>
                            )
                        })}
            ...
            <div className='space-y-8'>
                <div className='flex flex-col lg:flex-row lg:justify-between lg:items-end gap-5'>
                    <div>
                        <h3 className='text-2xl font-black text-gray-900 dark:text-white tracking-tight'>Patient Feedback</h3>
                    ...
                    <div className='flex flex-wrap items-center gap-3 w-full lg:w-auto'>
                        <div className='relative min-w-[240px] flex-1 lg:flex-none'>
                            ...
                            <input
                                ...
                                className='w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary'
                            />
                        </div>
                        ...
                        <select
                            ...
                            className='px-3 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-xs font-black uppercase tracking-wider text-gray-600 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary'
                        >
                        ...
                        {(searchTerm || selectedRating !== 'all' || sortBy !== 'recent') && (
                            <button
                                ...
                                className='px-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-[10px] font-black uppercase tracking-widest text-gray-500 dark:text-gray-400 hover:border-primary hover:text-primary transition-all shadow-sm dark:shadow-none'
                            >
                                Clear
                            </button>
                        )}
                ...
                {filteredAndSortedReviews.length === 0 ? (
                    <div className='bg-white dark:bg-gray-800 p-32 rounded-[4rem] border-4 border-dashed border-gray-100 flex flex-col items-center justify-center text-center grayscale opacity-50'>
                        <div className='w-24 h-24 bg-gray-50 dark:bg-gray-900 rounded-[2.5rem] flex items-center justify-center mb-8'>
                        ...
                        <h4 className='font-black text-2xl text-gray-800 dark:text-gray-100 tracking-tight'>{reviews.length ? 'No matching feedback' : 'Silence is Golden...'}</h4>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                        {filteredAndSortedReviews.map((review) => (
                            <div key={review._id || review.appointmentId || `${review.userName}-${review.date}`} className='bg-white dark:bg-gray-800 p-10 rounded-[3rem] shadow-card border border-gray-100 hover:shadow-medical hover:border-amber-100 transition-all duration-500 relative group'>
                                    ...
                                    <div className='flex items-center gap-5'>
                                        <div className='relative'>
                                            ...
                                            <img
                                                ...
                                                className='w-16 h-16 rounded-[1.8rem] object-cover relative z-10 border-4 border-gray-50 group-hover:border-white transition-all duration-500 shadow-sm dark:shadow-none'
                                                alt=''
                                            />
                                        ...
                                        <div>
                                            <h4 className='font-black text-gray-900 dark:text-white text-lg leading-tight'>{review.userName}</h4>
                                            <div className='flex items-center gap-2 mt-1'>
                                                <span className='text-[10px] font-black text-gray-400 uppercase tracking-widest bg-gray-50 dark:bg-gray-900 px-3 py-1 rounded-full group-hover:bg-amber-50 group-hover:text-amber-600 transition-colors'>
                                                    Verified Experience
                                                </span>
                                ...
                                <div className='relative'>
                                    ...
                                    <p className='text-gray-600 dark:text-gray-300 leading-[1.8] text-base relative z-10 pl-4 italic font-medium group-hover:text-gray-900 dark:text-white transition-colors'>
                                        {review.comment}
                                    </p>
                                </div>
                                ...
                                <div className='mt-10 pt-8 border-t border-gray-50 flex justify-between items-center opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0'>
                                    <div className='flex gap-2'>
                                        <span className='px-4 py-1.5 bg-gray-50 dark:bg-gray-900 rounded-full text-[10px] font-black uppercase tracking-widest text-gray-400'>Consultation</span>
                                        <span className='px-4 py-1.5 bg-gray-50 dark:bg-gray-900 rounded-full text-[10px] font-black uppercase tracking-widest text-gray-400'>Verified</span>
                                    </div>
