    ...
    return profileData && (
        <div className='m-5 max-w-7xl mx-auto space-y-8 animate-fade-in-up'>
            ...
            <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-6'>
                <div>
                    <h1 className='text-4xl font-black text-gray-900 dark:text-white font-outfit tracking-tight'>Professional Identity</h1>
                ...
                <div className='flex gap-4'>
                    {isEdit ? (
                        <>
                            <button onClick={() => setIsEdit(false)} className='px-8 py-3 rounded-2xl border-2 border-gray-100 text-gray-600 dark:text-gray-300 font-bold hover:bg-gray-50 dark:bg-gray-900 transition-all'>Cancel</button>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
                ...
                <div className='lg:col-span-4 space-y-8'>
                    <div className='bg-white dark:bg-gray-800 rounded-[3rem] shadow-card border border-gray-100 overflow-hidden group'>
                        <div className='h-40 bg-gradient-to-br from-primary to-indigo-600 relative overflow-hidden'>
                            ...
                            <div className='absolute -bottom-12 -right-12 w-48 h-48 bg-white dark:bg-gray-800/10 rounded-full blur-3xl'></div>
                        </div>
                        <div className='px-8 pb-10 relative'>
                            ...
                            <div className='text-center space-y-4'>
                                {isEdit ? (
                                    <div className='space-y-4'>
                                        <input
                                            ...
                                            className='w-full text-center text-2xl font-black text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-900 border border-gray-100 rounded-2xl py-2 focus:outline-none'
                                        />
                                        <div className='grid grid-cols-2 gap-3'>
                                            <input
                                                ...
                                                className='bg-gray-50 dark:bg-gray-900 border border-gray-100 rounded-xl px-3 py-2 text-sm text-center'
                                            />
                                            <input
                                    ...
                                    <>
                                        <div>
                                            <h2 className='text-3xl font-black text-gray-900 dark:text-white font-outfit uppercase tracking-tight'>{profileData.name}</h2>
                                            <p className='text-primary font-bold text-lg mt-1'>{profileData.speciality}</p>
                                        </div>
                                        <div className='flex items-center justify-center gap-3'>
                                            <span className='px-4 py-1.5 bg-gray-50 dark:bg-gray-900 text-gray-500 dark:text-gray-400 text-xs font-black uppercase tracking-widest rounded-full border border-gray-100'>{profileData.degree}</span>
                                ...
                                <div className={`p-5 rounded-[2rem] transition-all duration-500 border ${profileData.available ? 'bg-emerald-50 border-emerald-100' : 'bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700'}`}>
                                    <div className='flex items-center justify-between mb-2'>
                                        <span className='text-sm font-black text-gray-600 dark:text-gray-300 uppercase tracking-widest'>Availability Status</span>
                    ...
                    {/* Practice Details */}
                    <div className='bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-card border border-gray-100 p-8 space-y-6'>
                        <h3 className='text-xl font-black text-gray-900 dark:text-white font-outfit uppercase tracking-widest'>Practice Details</h3>
                        <div className='space-y-6'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    {isEdit ? (
                                        <div className='space-y-2'>
                                            <input value={profileData.address.line1} onChange={(e) => setProfileData(prev => ({ ...prev, address: { ...prev.address, line1: e.target.value } }))} className='w-full bg-gray-50 dark:bg-gray-900 p-2 rounded-lg text-sm' placeholder="Street" />
                                            <input value={profileData.address.line2} onChange={(e) => setProfileData(prev => ({ ...prev, address: { ...prev.address, line2: e.target.value } }))} className='w-full bg-gray-50 dark:bg-gray-900 p-2 rounded-lg text-sm' placeholder="City, Zip" />
                                        </div>
                                    ) : (
                                        <p className='text-gray-700 dark:text-gray-200 font-bold'>{profileData.address.line1}<br /><span className='text-gray-400 font-medium text-sm'>{profileData.address.line2}</span></p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className='flex items-start gap-4'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    {isEdit ? (
                                        <input value={profileData.languages?.join(', ')} onChange={(e) => setProfileData(prev => ({ ...prev, languages: e.target.value.split(',').map(s => s.trim()) }))} className='w-full bg-gray-50 dark:bg-gray-900 p-2 rounded-lg text-sm font-bold' placeholder="Comma separated" />
                                    ) : (
                ...
                <div className='lg:col-span-8 space-y-8'>
                    ...
                    <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                        {stats.map((stat, index) => (
                            <div key={index} className='bg-white dark:bg-gray-800 p-6 rounded-[2rem] shadow-card border border-gray-100 group hover:shadow-medical transition-all duration-300'>
                                ...
                                <div className='flex items-baseline gap-2'>
                                    <h4 className='text-2xl font-black text-gray-900 dark:text-white font-outfit'>{stat.value}</h4>
                    ...
                    {/* About Practitioner */}
                    <div className='bg-white dark:bg-gray-800 rounded-[3rem] shadow-card border border-gray-100 p-10 relative overflow-hidden'>
                        <div className='absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl'></div>
                        <div className='relative z-10'>
                            <h3 className='text-2xl font-black text-gray-900 dark:text-white font-outfit uppercase tracking-tight mb-6 flex items-center gap-3'>
                            ...
                            {isEdit ? (
                                <textarea
                                    ...
                                    className='w-full bg-gray-50 dark:bg-gray-900 border border-gray-100 rounded-3xl p-6 text-gray-700 dark:text-gray-200 leading-relaxed focus:outline-none'
                                    placeholder="Briefly describe your medical philosophy and expertise..."
                                />
                            ) : (
                                <p className='text-gray-600 dark:text-gray-300 text-lg leading-relaxed italic font-medium'>" {profileData.about} "</p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                        ...
                        <div className='space-y-8'>
                            <div className='bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-card border border-gray-100 p-8'>
                                <h3 className='text-lg font-black text-gray-900 dark:text-white font-outfit uppercase tracking-widest mb-6 flex items-center gap-2'>
                                    <span className='text-xl'>🏆</span> Recognition
                                </h3>
                                <div className='space-y-4'>
                                    {isEdit ? (
                                        <textarea value={profileData.awards?.join(', ')} onChange={(e) => setProfileData(prev => ({ ...prev, awards: e.target.value.split(',').map(s => s.trim()) }))} className='w-full bg-gray-50 dark:bg-gray-900 rounded-xl p-3 text-sm' placeholder="Separate by commas" />
                                    ) : (
                        ...
                        <div className='bg-gray-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden group shadow-2xl'>
                            ...
                            <div className='relative z-10'>
                                <div className='flex justify-between items-center mb-8'>
                                    ...
                                    <div className='px-3 py-1 bg-white dark:bg-gray-800/10 rounded-full text-[10px] font-black uppercase tracking-tighter text-emerald-400'>Active Layer</div>
                                </div>
                                ...
                                {isEdit ? (
                                    <div className='space-y-4'>
                                        <input
                                            ...
                                            className='w-full bg-white dark:bg-gray-800/5 border border-white/10 rounded-xl px-4 py-2 text-sm' placeholder="Insurer"
                                        />
                                        <input
                                            value={profileData.insurance?.policyNo}
                                            onChange={(e) => setProfileData(prev => ({ ...prev, insurance: { ...prev.insurance, policyNo: e.target.value } }))}
                                            className='w-full bg-white dark:bg-gray-800/5 border border-white/10 rounded-xl px-4 py-2 text-sm' placeholder="Policy #"
                                        />
                                    </div>
                                ) : (
                                    <div className='space-y-6'>
                                        ...
                                        <div className='mt-8 flex items-center gap-4 p-4 bg-white dark:bg-gray-800/5 rounded-2xl border border-white/10'>
                            ...
                            {isEdit ? (
                                <div className='relative'>
                                    ...
                                    <input
                                        ...
                                        className='bg-white dark:bg-gray-800/10 border-2 border-white/20 rounded-[2rem] pl-10 pr-6 py-4 text-3xl font-black w-48 text-center focus:outline-none'
                                    />
                                </div>
                            ) : (
                                <div className='bg-white dark:bg-gray-800/10 backdrop-blur-xl border border-white/20 rounded-[2rem] px-10 py-6 text-center transform group-hover:scale-105 transition-all'>
