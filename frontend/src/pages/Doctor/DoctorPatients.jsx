...
const DoctorPatients = () => {
    ...
    const getEngagementStatus = (lastVisit) => {
        if (!lastVisit) return { label: 'No Visits', dot: 'bg-gray-300', chip: 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 border-gray-200 dark:border-gray-700' }
        ...
        return { label: 'Dormant', dot: 'bg-gray-400', chip: 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 border-gray-200 dark:border-gray-700' }
    }
    ...
    return (
        <div className='flex flex-col gap-8 m-5 max-w-7xl animate-fade-in-up'>
            ...
            <div className='flex flex-col md:flex-row md:items-end md:justify-between gap-4'>
                <div>
                    <h2 className='text-4xl font-black text-gray-900 dark:text-white font-outfit tracking-tight'>Patients Directory</h2>
                    <p className='text-gray-500 dark:text-gray-400 mt-2 text-lg'>Manage your patient relationships and clinical history in one place.</p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6'>
                <div className='bg-gradient-primary p-1 rounded-3xl shadow-medical group cursor-default transition-all hover:scale-[1.02]'>
                    <div className='bg-white dark:bg-gray-800 rounded-[1.4rem] p-6 h-full flex items-center gap-5'>
                        <div className='w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center text-primary'>
                            <svg className='w-8 h-8' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' /></svg>
                        </div>
                        <div>
                            <p className='text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider'>Total Patients</p>
                ...
                <div className='bg-gradient-secondary p-1 rounded-3xl shadow-medical group cursor-default transition-all hover:scale-[1.02]'>
                    <div className='bg-white dark:bg-gray-800 rounded-[1.4rem] p-6 h-full flex items-center gap-5'>
                        ...
                        <div>
                            <p className='text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider'>This Month</p>
                            <h3 className='text-3xl font-black text-gray-900 dark:text-white'>+{stats.newThisMonth}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div className='bg-gradient-trust p-1 rounded-3xl shadow-medical group cursor-default transition-all hover:scale-[1.02]'>
                    <div className='bg-white dark:bg-gray-800 rounded-[1.4rem] p-6 h-full flex items-center gap-5'>
                        ...
                        <div>
                            <p className='text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider'>Avg. Visits</p>
                            <h3 className='text-3xl font-black text-gray-900 dark:text-white'>{stats.avgVisits}</h3>
                        </div>
                    </div>
                </div>

                <div className='bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 p-6 shadow-sm dark:shadow-none'>
                    <p className='text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider'>Currently Active</p>
                    <h3 className='text-3xl font-black text-gray-900 dark:text-white mt-1'>{stats.activeCount}</h3>
                    <p className='text-xs text-gray-500 dark:text-gray-400 mt-2'>Patients seen in the last 45 days.</p>
                </div>
            </div>

            {/* Main Content Area */}
            <div className='bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-card overflow-hidden border border-gray-100'>
                {/* Search and Filters Bar */}
                <div className='p-8 border-b border-gray-100 bg-gray-50 dark:bg-gray-900/50'>
                    <div className='flex flex-col lg:flex-row justify-between items-center gap-6'>
                        <div className='relative w-full lg:max-w-md group'>
                            ...
                            <input
                                ...
                                className='w-full pl-12 pr-6 py-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all text-gray-700 dark:text-gray-200 shadow-sm dark:shadow-none'
                            />
                        </div>
                        ...
                        <div className='flex items-center gap-4 w-full lg:w-auto'>
                            {(searchTerm || sortBy !== 'name') && (
                                <button
                                    ...
                                    className='px-4 py-4 rounded-2xl border border-gray-200 dark:border-gray-700 text-xs font-black uppercase tracking-wider text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-800 transition-all'
                                >
                                    Clear
                                </button>
                            )}
                            <span className='text-sm font-bold text-gray-500 dark:text-gray-400 uppercase hidden sm:inline'>Sort by:</span>
                            <select
                                value={sortBy}
                                onChange={(e) => setSortBy(e.target.value)}
                                className='flex-1 lg:flex-none px-6 py-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all font-bold text-gray-700 dark:text-gray-200 cursor-pointer shadow-sm dark:shadow-none appearance-none pr-12 relative'
                ...
                <div className='p-0 sm:p-4'>
                    {loading ? (
                        ...
                        <div className='text-center py-32 bg-gray-50 dark:bg-gray-900/50 rounded-3xl m-4 border-2 border-dashed border-gray-200 dark:border-gray-700'>
                            <div className='text-7xl mb-6 grayscale opacity-50'>🔍</div>
                            <h4 className='text-2xl font-bold text-gray-800 dark:text-gray-100'>No results found</h4>
                            ...
                            <table className='w-full'>
                                ...
                                <tbody className='divide-y divide-gray-50'>
                                    {filteredAndSortedPatients.map((patient) => (
                                        <tr key={patient._id || patient.email} className='group hover:bg-gray-50 dark:bg-gray-900/80 transition-all duration-300'>
                                            <td className='py-6 px-8'>
                                                <div className='flex items-center gap-5'>
                                                    ...
                                                    <div>
                                                        <p className='font-black text-gray-900 dark:text-white font-outfit text-lg group-hover:text-primary transition-colors'>{patient.name || 'Unknown User'}</p>
                                                        <div className='flex items-center gap-3 mt-1'>
                                                            <span className='px-2 py-0.5 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 rounded-md text-[10px] font-black uppercase tracking-wider'>
                                                                {patient.gender || 'N/A'}
                                                            </span>
                                            ...
                                            <td className='py-6 px-8'>
                                                <div className='space-y-1.5'>
                                                    <div className='text-sm font-bold text-gray-700 dark:text-gray-200 flex items-center gap-2.5'>
                                                        <span className='w-7 h-7 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center'>
                                                    ...
                                                    <div className='text-sm text-gray-500 dark:text-gray-400 flex items-center gap-2.5'>
                                                        <span className='w-7 h-7 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center'>
                                            ...
                                            <td className='py-6 px-8 text-right'>
                                                <button
                                                    ...
                                                    className='px-6 py-3 bg-white dark:bg-gray-800 border-2 border-primary text-primary rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-primary hover:text-white transition-all transform hover:-translate-y-1 active:scale-95 shadow-sm dark:shadow-none hover:shadow-medical'
                                                >
                                                    View Timeline
                                                </button>
                                            </td>
            ...
            {showHistoryModal && selectedPatient && (
                <div className='fixed inset-0 z-[60] flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-xl animate-fade-in'>
                    <div className='bg-white dark:bg-gray-800 rounded-[3rem] shadow-2xl w-full max-w-5xl max-h-[92vh] overflow-hidden flex flex-col animate-scale-in border border-white/20'>
                        {/* Modal Header */}
                        <div className='relative p-10 bg-gradient-primary text-white overflow-hidden'>
                            {/* Decorative Elements */}
                            <div className='absolute top-0 right-0 w-64 h-64 bg-white dark:bg-gray-800/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl'></div>
                            ...
                            <div className='relative flex flex-col md:flex-row items-center justify-between gap-8'>
                                <div className='flex flex-col md:flex-row items-center gap-8'>
                                    <div className='relative'>
                                        ...
                                        <div className='absolute -top-2 -right-2 w-10 h-10 bg-white dark:bg-gray-800 text-primary rounded-2xl flex items-center justify-center shadow-lg font-black'>
                                    ...
                                    <div className='text-center md:text-left'>
                                        ...
                                        <div className='flex flex-wrap justify-center md:justify-start items-center gap-4 mt-4'>
                                            <span className='px-4 py-2 bg-white dark:bg-gray-800/10 backdrop-blur-md rounded-2xl font-black text-xs uppercase'>{selectedPatient.gender}</span>
                                            <span className='w-1.5 h-1.5 bg-white dark:bg-gray-800/30 rounded-full'></span>
                                            <span className='px-4 py-2 bg-white dark:bg-gray-800/10 backdrop-blur-md rounded-2xl font-black text-xs uppercase'>
                                                {calculateAge(selectedPatient.dob)}
                                            </span>
                                            <span className='w-1.5 h-1.5 bg-white dark:bg-gray-800/30 rounded-full'></span>
                                            <span className='px-4 py-2 bg-white dark:bg-gray-800/10 backdrop-blur-md rounded-2xl font-black text-xs uppercase truncate max-w-[200px]'>
                                ...
                                <button
                                    ...
                                    className='p-4 bg-white dark:bg-gray-800/10 hover:bg-white dark:bg-gray-800/20 rounded-3xl transition-all border border-white/10 group'
                                >
                        ...
                        {/* Modal Body */}
                        <div className='flex-1 overflow-y-auto p-10 bg-gray-50 dark:bg-gray-900/50 custom-scrollbar'>
                            <div className='grid grid-cols-1 lg:grid-cols-4 gap-10'>
                                {/* Left Side: Patient Metrics */}
                                <div className='lg:col-span-1 space-y-6'>
                                    <div className='bg-white dark:bg-gray-800 p-6 rounded-[2rem] shadow-sm dark:shadow-none border border-gray-100'>
                                        <h4 className='text-xs font-black text-gray-400 uppercase tracking-widest mb-6'>Quick Overview</h4>
                                        <div className='space-y-6'>
                                            <div className='flex justify-between items-center'>
                                                <span className='text-sm font-bold text-gray-500 dark:text-gray-400'>First Visit</span>
                                                <span className='text-sm font-black text-gray-900 dark:text-white'>{historySummary.firstVisit}</span>
                                            </div>
                                            <div className='flex justify-between items-center'>
                                                <span className='text-sm font-bold text-gray-500 dark:text-gray-400'>Last Visit</span>
                                                <span className='text-sm font-black text-gray-900 dark:text-white'>{historySummary.lastVisit}</span>
                                            </div>
                                            <div className='flex justify-between items-center'>
                                                <span className='text-sm font-bold text-gray-500 dark:text-gray-400'>Last Notes</span>
                                                <span className='text-xs font-black text-gray-900 dark:text-white text-right max-w-[140px] line-clamp-2'>
                                                    {historySummary.lastNotes}
                                                </span>
                                            </div>
                                            <div className='flex justify-between items-center'>
                                                <span className='text-sm font-bold text-gray-500 dark:text-gray-400'>Follow-through</span>
                                ...
                                <div className='lg:col-span-3'>
                                    <div className='flex items-center justify-between mb-8'>
                                        <h3 className='text-3xl font-black text-gray-900 dark:text-white font-outfit'>Clinical Journey</h3>
                                        <div className='flex items-center gap-3'>
                                            <button
                                                onClick={() => selectedPatient && viewPatientHistory(selectedPatient)}
                                                disabled={historyLoading}
                                                className='px-4 py-2 bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-none border border-gray-100 text-xs font-black text-gray-600 dark:text-gray-300 uppercase tracking-widest hover:bg-gray-50 dark:bg-gray-900 transition-all disabled:opacity-60 disabled:cursor-not-allowed'
                                            >
                                                {historyLoading ? 'Refreshing...' : 'Refresh History'}
                                            </button>
                                            <div className='px-4 py-2 bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-none border border-gray-100 text-xs font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest'>
                                    ...
                                    {historyLoading ? (
                                        <div className='space-y-5 py-8'>
                                            {[1, 2, 3].map((item) => (
                                                <div key={item} className='bg-white dark:bg-gray-800 border border-gray-100 rounded-3xl p-6 animate-pulse'>
                                        ...
                                        <div className='bg-white dark:bg-gray-800 p-20 rounded-[3rem] border-4 border-dashed border-gray-100 text-center'>
                                            <div className='text-6xl mb-6'>📁</div>
                                            <p className='text-gray-400 font-black uppercase tracking-widest'>No clinical history found</p>
                                            <p className='text-sm text-gray-500 dark:text-gray-400 mt-3'>This patient has no appointment timeline yet.</p>
                                        </div>
                                    ) : (
                                        <div className='relative space-y-10 before:absolute before:left-[2.75rem] before:top-4 before:bottom-4 before:w-1.5 before:bg-gray-100 dark:bg-gray-800 before:rounded-full'>
                                            {patientHistory.map((apt, idx) => (
                                                <div key={idx} className='relative flex gap-10 group'>
                                                    ...
                                                    {/* Content Card */}
                                                    <div className='flex-1 bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-soft border border-gray-100 group-hover:shadow-card transition-all group-hover:-translate-x-2'>
                                                        <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6'>
                                                            <div>
                                                                <div className='flex items-center gap-3'>
                                                                    <h4 className='text-2xl font-black text-gray-900 dark:text-white font-outfit uppercase tracking-tight'>{apt.diagnosis || 'General Checkup'}</h4>
                                                            ...
                                                            <span className={`px-6 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] shadow-sm dark:shadow-none ${apt.isCompleted ? 'bg-green-50 text-green-600 border border-green-100' :
                                                        ...
                                                        {apt.isCompleted && (
                                                            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 pt-8 border-t border-gray-50'>
                                                                <div className='space-y-4'>
                                                                    ...
                                                                    <div className='flex flex-wrap gap-2'>
                                                                        {apt.medications && apt.medications.length > 0 ? apt.medications.map((med, mIdx) => (
                                                                            <span key={mIdx} className='px-4 py-2 bg-gray-50 dark:bg-gray-900 text-gray-700 dark:text-gray-200 rounded-xl text-xs font-bold border border-gray-100'>
                                                                                {med}
                                                                            </span>
                                                                ...
                                                                <div className='space-y-4'>
                                                                    ...
                                                                    <p className='text-xs font-bold text-gray-500 dark:text-gray-400 leading-relaxed bg-purple-50/30 p-4 rounded-2xl border border-purple-100/30'>
                        ...
                        {/* Modal Footer */}
                        <div className='p-8 bg-white dark:bg-gray-800 border-t border-gray-50 flex items-center justify-between'>
