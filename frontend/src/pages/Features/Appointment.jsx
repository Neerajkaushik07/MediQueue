  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex gap-4 mt-6">
         <button type="button" onClick={onCancel} disabled={isProcessing} className="flex-1 px-4 py-3 border border-gray-200 text-gray-600 font-semibold rounded-xl hover:bg-gray-50 transition-colors">Cancel</button>
         <button type="submit" disabled={!stripe || isProcessing} className="flex-1 bg-gradient-primary text-white py-3 rounded-xl font-bold shadow-lg shadow-blue-500/30 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300">
        ...
        {showStripeModal && stripeClientSecret && (
          <div className='fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in'>
            <div className='bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden'>
              <div className='bg-gradient-to-r from-blue-50 to-blue-100/50 p-6 border-b border-blue-100 flex justify-between items-center'>
                <div>
                ...
                <button onClick={handleCancelHold} className='text-gray-400 hover:text-gray-600 transition-colors p-2 hover:bg-white rounded-full'>
