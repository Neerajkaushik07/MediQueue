...
const LabReports = () => {
    ...
    const normalCount = reports.filter(r => r.overallStatus === 'normal').length
                ...
                <div className='relative overflow-hidden rounded-3xl border border-cyan-100 bg-gradient-to-r from-cyan-50 via-white to-emerald-50 p-6 md:p-8 mb-8'>
                    ...
                    <div className='relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6'>
                        ...
                        <button
                            ...
                            className='px-6 py-3 bg-gradient-to-r from-cyan-600 to-sky-700 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all flex items-center gap-2 self-start md:self-auto'
                        >
                        ...
                        filteredReports.map(report => (
                            ...
                            >
                                ...
                                <div className='flex items-center justify-between text-sm pt-4 border-t border-slate-100'>
                                    ...
                                    <span className='text-cyan-700 font-bold group-hover:translate-x-1 transition-transform'>
                                        View Details →
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className='p-8 overflow-y-auto w-full h-full'>
                            ...
                            <div className='mt-10 flex gap-4'>
                                <button
                                    ...
                                    className='flex-1 py-4 bg-gradient-to-r from-cyan-600 to-sky-700 text-white font-bold rounded-2xl shadow-md hover:shadow-lg transition-all'
                                >
                                    Download PDF
                                </button>
                            </div>
                            ...
                            <form onSubmit={handleAddReport} className='space-y-6'>
                                ...
                                <div>
                                    <h3 className='text-lg font-bold mb-4 flex items-center justify-between'>
                                        ...
                                        <button type='button' onClick={addResultRow} className='text-sm text-cyan-700 hover:underline'>+ Add Row</button>
                                    </h3>
