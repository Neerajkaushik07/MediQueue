...
const FamilyHealth = () => {
    ...
    const getInsuranceStatus = (endDate) => {
        ...
        if (Number.isNaN(diffDays)) return { label: 'Unknown', badgeClass: 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300', daysRemaining: null }
            ...
            <div className='max-w-7xl mx-auto'>
                ...
                <div className='relative overflow-hidden rounded-3xl border border-cyan-100 bg-gradient-to-r from-cyan-50 via-white to-emerald-50 p-6 md:p-8 mb-8'>
                    ...
                    <div className='relative'>
                        ...
                        <h1 className='text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2'>Family Health Hub</h1>
                        <p className='text-slate-600 dark:text-slate-300 max-w-2xl'>Manage health records, insurance coverage, and billing for every family member from one place.</p>
                    </div>
                </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8'>
                    <div className='rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm dark:shadow-none'>
                        <p className='text-sm text-slate-500 dark:text-slate-400 mb-1'>Family Members</p>
                        <p className='text-3xl font-black text-slate-900 dark:text-white'>{familyMembers.length}</p>
                    </div>
                    <div className='rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm dark:shadow-none'>
                        <p className='text-sm text-slate-500 dark:text-slate-400 mb-1'>Active Policies</p>
                        <p className='text-3xl font-black text-emerald-600'>{activePoliciesCount}</p>
                    </div>
                    <div className='rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm dark:shadow-none'>
                        <p className='text-sm text-slate-500 dark:text-slate-400 mb-1'>Outstanding Bills</p>
                        <p className='text-3xl font-black text-amber-600'>{pendingBillsCount}</p>
                    </div>
                    <div className='rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm dark:shadow-none'>
                        <p className='text-sm text-slate-500 dark:text-slate-400 mb-1'>Total Billed</p>
                ...
                {activeEmergency && (
                    <div className='rounded-2xl p-4 mb-8 border border-amber-200 bg-amber-50 flex items-center justify-between gap-4'>
                        <div>
                            ...
                            <p className='text-slate-800 dark:text-slate-100 font-semibold'>Care team has been alerted. Request ID: {activeEmergency._id}</p>
                            {activeEmergency.createdAt && (
                                <p className='text-xs text-slate-600 dark:text-slate-300 mt-1'>Started: {new Date(activeEmergency.createdAt).toLocaleString()}</p>
                            )}
                        </div>
                        <button
                ...
                {/* Tab Navigation */}
                <div className='flex gap-2 mb-8 bg-white dark:bg-gray-800 p-2 rounded-2xl border border-slate-200 dark:border-gray-700 shadow-sm dark:shadow-none max-w-3xl overflow-x-auto'>
                    {tabs.map(tab => (
                        <button
                            key={tab.id}
                            ...
                            className={`flex-1 flex items-center justify-center gap-3 px-5 py-3 rounded-xl font-bold transition-all ${activeTab === tab.id
                                ...
                                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:bg-gray-900'
                                }`}
                        >
                ...
                <div className='min-h-[400px]'>
                    {loading ? (
                        ...
                        <div className='animate-fade-in'>
                            ...
                            {activeTab === 'family' && (
                                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                                    {familyMembers.map(member => (
                                        <div key={member._id} className='rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 group hover:shadow-lg transition-all'>
                                            ...
                                            <div className='space-y-3 mb-6'>
                                                <div className='flex justify-between text-sm py-2 border-b border-slate-100'>
                                                    ...
                                                    <span className='font-bold text-slate-700 dark:text-slate-200'>{member.age} yrs • {member.gender}</span>
                                                </div>
                                                <div className='flex justify-between text-sm py-2 border-b border-slate-100'>
                                            ...
                                            <div className='flex gap-3 items-center'>
                                                <button
                                                    ...
                                                    className='flex-1 py-3 bg-slate-50 dark:bg-gray-900 hover:bg-cyan-600 hover:text-white rounded-xl font-bold transition-all text-slate-700 dark:text-slate-200 flex items-center justify-center gap-2'
                                                >
                                    ...
                                    <button
                                        ...
                                        className='rounded-2xl border-2 border-dashed border-slate-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-6 flex flex-col items-center justify-center gap-4 hover:border-cyan-500 hover:bg-cyan-50/50 transition-all group'
                                    >
                                        <div className='w-16 h-16 bg-slate-100 dark:bg-gray-800 rounded-full flex items-center justify-center group-hover:bg-cyan-600 group-hover:text-white transition-all'>
                                            <FaPlus className='text-2xl' />
                                        </div>
                                        <span className='font-bold text-slate-500 dark:text-slate-400 group-hover:text-cyan-700'>Add Family Member</span>
                                    </button>
                                </div>
                            )}
                            ...
                            {activeTab === 'insurance' && (
                                <div className='space-y-6'>
                                    {insurancePolicies.map(policy => {
                                        const status = getInsuranceStatus(policy.endDate)
                                        return (
                                            <div key={policy._id} className='rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 md:p-8 flex flex-col md:flex-row gap-8 items-start justify-between hover:shadow-lg transition-all'>
                                                <div className='flex gap-6 items-center'>
                                                    ...
                                                    <div>
                                                        ...
                                                        <h3 className='text-2xl font-bold text-slate-900 dark:text-white'>{policy.providerName}</h3>
                                                        <p className='text-slate-500 dark:text-slate-400'>Policy #: <span className='font-mono font-bold'>{policy.policyNumber}</span></p>
                                                ...
                                                <div className='flex flex-wrap gap-8 w-full md:w-auto'>
                                                    <div className='min-w-[120px]'>
                                                        ...
                                                        <p className='font-bold text-slate-700 dark:text-slate-200'>{policy.type}</p>
                                                    </div>
                                                    <div className='min-w-[120px]'>
                                                        <p className='text-xs font-bold text-slate-400 uppercase mb-1'>Expiry Date</p>
                                                        <p className='font-bold text-slate-700 dark:text-slate-200'>{new Date(policy.endDate).toLocaleDateString()}</p>
                                                    </div>
                                                    <div className='min-w-[120px]'>
                                                ...
                                                <button
                                                    ...
                                                    className='p-4 hover:bg-slate-100 dark:bg-gray-800 rounded-2xl transition-colors'
                                                >
                                    ...
                                    <button
                                        ...
                                        className='w-full py-8 border-2 border-dashed border-slate-300 dark:border-gray-600 rounded-3xl flex items-center justify-center gap-4 hover:border-cyan-500 hover:bg-cyan-50 transition-all text-slate-400 hover:text-cyan-700 font-bold'
                                    >
                            ...
                            {activeTab === 'billing' && (
                                <div className='space-y-6'>
                                    <div className='rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 flex flex-wrap gap-4 items-end shadow-sm dark:shadow-none'>
                                        <div className='flex-1 min-w-[200px]'>
                                            ...
                                            <input
                                                ...
                                                className='w-full px-3 py-2 border border-slate-200 dark:border-gray-700 rounded-xl bg-slate-50 dark:bg-gray-900 focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none'
                                            />
                                        </div>
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className='px-3 py-2 border border-slate-200 dark:border-gray-700 rounded-xl bg-slate-50 dark:bg-gray-900 focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none'
                                            >
                                        ...
                                        <div>
                                            ...
                                            <input type='date' value={billFilters.startDate} onChange={e => setBillFilters({ ...billFilters, startDate: e.target.value })} className='px-3 py-2 border border-slate-200 dark:border-gray-700 rounded-xl bg-slate-50 dark:bg-gray-900 focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' />
                                        </div>
                                        <div>
                                            <label className='block text-xs font-bold text-slate-500 dark:text-slate-400 mb-1'>End date</label>
                                            <input type='date' value={billFilters.endDate} onChange={e => setBillFilters({ ...billFilters, endDate: e.target.value })} className='px-3 py-2 border border-slate-200 dark:border-gray-700 rounded-xl bg-slate-50 dark:bg-gray-900 focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' />
                                        </div>
                                        <div className='flex gap-2'>
                                            <button onClick={handleExportBillsCSV} type='button' className='px-4 py-2 bg-slate-100 dark:bg-gray-800 rounded-xl text-slate-700 dark:text-slate-200 font-semibold hover:bg-slate-200'>Export CSV</button>
                                    ...
                                    <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                                        <div className='rounded-2xl p-5 border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm dark:shadow-none'>
                                            <p className='text-xs font-bold text-slate-400 uppercase mb-1'>Total Billed</p>
                                            <p className='text-3xl font-bold text-slate-900 dark:text-white'>${Number(filteredSummary.total || 0).toLocaleString()}</p>
                                            <p className='text-sm text-slate-500 dark:text-slate-400 mt-1'>Filtered invoices</p>
                                        </div>
                                        <div className='rounded-2xl p-5 border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm dark:shadow-none'>
                                            ...
                                            <p className='text-sm text-slate-500 dark:text-slate-400 mt-1'>Settled invoices</p>
                                        </div>
                                    ...
                                    <div className='rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden shadow-sm dark:shadow-none'>
                                        <table className='w-full text-left'>
                                            <thead>
                                                <tr className='bg-slate-50 dark:bg-gray-900 border-b border-slate-100'>
                                            ...
                                            <tbody className='divide-y divide-slate-100'>
                                                {filteredBills.length === 0 && (
                                                    <tr>
                                                        <td colSpan='6' className='px-8 py-6 text-center text-slate-500 dark:text-slate-400'>No bills match your filters.</td>
                                                    </tr>
                                                )}
                                                {filteredBills.map(bill => (
                                                    <tr key={bill._id} className={`transition-colors ${bill.paymentStatus !== 'paid' ? 'bg-amber-50/30 hover:bg-amber-50/60' : 'hover:bg-slate-50 dark:bg-gray-900/70'}`}>
                                                        <td className='px-8 py-6'>
                                                            <span className='font-mono font-bold text-slate-800 dark:text-slate-100'>{bill.billNumber}</span>
                                                        </td>
                                                        ...
                                                        <td className='px-8 py-6'>
                                                            <div className='flex flex-col'>
                                                                <span className='font-bold text-slate-900 dark:text-white'>${bill.totalAmount}</span>
                ...
                {showMemberModal && (
                    <div className='fixed inset-0 bg-black/60 backdrop-blur-sm flex items-start pt-[10vh] sm:pt-[15vh] justify-center z-50 p-4 overflow-y-auto'>
                        <div className='bg-white dark:bg-gray-800 rounded-3xl p-8 max-w-xl w-full animate-slide-up mb-20 border border-slate-200 dark:border-gray-700'>
                            <h2 className='text-2xl font-bold text-slate-900 dark:text-white mb-6'>{isEditingMember ? 'Edit Family Member' : 'Add Family Member'}</h2>
                            <form onSubmit={handleSubmitMember} className='space-y-4'>
                                <div className='grid grid-cols-2 gap-4'>
                                    <div className='col-span-2'>
                                        ...
                                        <input required type='text' className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' value={memberForm.name} onChange={e => setMemberForm({ ...memberForm, name: e.target.value })} />
                                    </div>
                                    <div className='col-span-2'>
                                        <label className='block text-sm font-bold text-slate-700 dark:text-slate-200 mb-1'>Profile Image URL (optional)</label>
                                        <input type='url' className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' placeholder='https://example.com/photo.jpg' value={memberForm.profileImage} onChange={e => setMemberForm({ ...memberForm, profileImage: e.target.value })} />
                                    </div>
                                    <div>
                                        <label className='block text-sm font-bold text-slate-700 dark:text-slate-200 mb-1'>Relationship</label>
                                        <div className='relative'>
                                            <button
                                                type='button'
                                                onClick={() => setShowRelationDropdown(!showRelationDropdown)}
                                                className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl text-left flex justify-between items-center'
                                            >
                                            ...
                                            {showRelationDropdown && (
                                                <>
                                                    ...
                                                    <div className='absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-xl shadow-xl max-h-48 overflow-y-auto top-full left-0'>
                                                        {['husband', 'wife', 'son', 'daughter', 'father', 'mother', 'brother', 'sister', 'grandfather', 'grandmother', 'uncle', 'aunt', 'cousin', 'nephew', 'niece', 'other'].map(rel => (
                                                            <div
                                                                key={rel}
                                                                className={`p-3 hover:bg-cyan-50 cursor-pointer capitalize text-sm ${memberForm.relationship === rel ? 'bg-cyan-100 text-cyan-700 font-bold' : 'text-slate-700 dark:text-slate-200'}`}
                                                                onClick={() => {
                                    ...
                                    <div>
                                        <label className='block text-sm font-bold text-slate-700 dark:text-slate-200 mb-1'>Age</label>
                                        <input required type='number' className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' value={memberForm.age} onChange={e => setMemberForm({ ...memberForm, age: e.target.value })} />
                                    </div>
                                    <div>
                                        <label className='block text-sm font-bold text-slate-700 dark:text-slate-200 mb-1'>Gender</label>
                                        <select className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' value={memberForm.gender} onChange={e => setMemberForm({ ...memberForm, gender: e.target.value })}>
                                    ...
                                    <div>
                                        <label className='block text-sm font-bold text-slate-700 dark:text-slate-200 mb-1'>Blood Group</label>
                                        <input type='text' className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' placeholder='e.g. A+' value={memberForm.bloodGroup} onChange={e => setMemberForm({ ...memberForm, bloodGroup: e.target.value })} />
                                    </div>
                                    <div className='col-span-2'>
                                        <label className='block text-sm font-bold text-slate-700 dark:text-slate-200 mb-1'>Allergies</label>
                                        <div className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl flex flex-wrap gap-2 min-h-[52px]'>
                                            ...
                                            <input
                                                ...
                                                className='flex-1 min-w-[160px] bg-transparent focus:outline-none text-sm text-slate-700 dark:text-slate-200'
                                            />
                                        </div>
                                        <p className='text-xs text-slate-500 dark:text-slate-400 mt-1'>Press Enter or comma to add each allergy.</p>
                                    </div>
                                </div>
                                <div className='flex gap-4 mt-8'>
                                    <button type='button' onClick={() => { setShowMemberModal(false); resetMemberForm() }} className='flex-1 py-3 bg-slate-100 dark:bg-gray-800 text-slate-600 dark:text-slate-300 font-bold rounded-xl'>Cancel</button>
                ...
                {showDeleteModal && (
                    <div className='fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4'>
                        <div className='bg-white dark:bg-gray-800 rounded-3xl p-8 max-w-md w-full animate-slide-up border border-slate-200 dark:border-gray-700'>
                            <div className='flex items-center gap-3 mb-4'>
                                <div className='w-12 h-12 rounded-xl bg-red-50 flex items-center justify-center text-red-500'>
                                    <FaTrash />
                                </div>
                                <div>
                                    <h2 className='text-xl font-bold text-slate-900 dark:text-white'>Remove family member?</h2>
                                    <p className='text-sm text-slate-600 dark:text-slate-300'>This action cannot be undone.</p>
                                </div>
                            </div>
                            <p className='text-slate-700 dark:text-slate-200 mb-6'>The member's records will no longer be linked to your account.</p>
                            <div className='flex gap-4'>
                                <button
                                    type='button'
                                    onClick={() => { setShowDeleteModal(false); setDeleteMemberId(null) }}
                                    className='flex-1 py-3 bg-slate-100 dark:bg-gray-800 text-slate-600 dark:text-slate-300 font-bold rounded-xl'
                                >
                                    Cancel
                                </button>
                                <button
                ...
                {showInsuranceModal && (
                    <div className='fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4'>
                        <div className='bg-white dark:bg-gray-800 rounded-3xl p-8 max-w-xl w-full animate-slide-up border border-slate-200 dark:border-gray-700'>
                            <h2 className='text-2xl font-bold text-slate-900 dark:text-white mb-6'>{isEditingInsurance ? 'Edit Insurance Policy' : 'Add Insurance Policy'}</h2>
                            <form onSubmit={handleAddInsurance} className='space-y-4'>
                                <div className='grid grid-cols-2 gap-4'>
                                    <div className='col-span-2'>
                                        <label className='block text-sm font-bold text-slate-700 dark:text-slate-200 mb-1'>Provider Name</label>
                                        <input required type='text' className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' value={insuranceForm.providerName} onChange={e => setInsuranceForm({ ...insuranceForm, providerName: e.target.value })} />
                                    </div>
                                    <div>
                                        <label className='block text-sm font-bold text-slate-700 dark:text-slate-200 mb-1'>Policy Number</label>
                                        <input required type='text' className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' value={insuranceForm.policyNumber} onChange={e => setInsuranceForm({ ...insuranceForm, policyNumber: e.target.value })} />
                                    </div>
                                    <div>
                                        <label className='block text-sm font-bold text-slate-700 dark:text-slate-200 mb-1'>Policy Type</label>
                                        <input required type='text' className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' placeholder='e.g. Life, Vision' value={insuranceForm.type} onChange={e => setInsuranceForm({ ...insuranceForm, type: e.target.value })} />
                                    </div>
                                    <div>
                                        <label className='block text-sm font-bold text-slate-700 dark:text-slate-200 mb-1'>Expiry Date</label>
                                        <input required type='date' className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' value={insuranceForm.endDate} onChange={e => setInsuranceForm({ ...insuranceForm, endDate: e.target.value })} />
                                    </div>
                                    <div>
                                        <label className='block text-sm font-bold text-slate-700 dark:text-slate-200 mb-1'>Premium</label>
                                        <input required type='text' className='w-full p-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 outline-none' placeholder='e.g. $50/mo' value={insuranceForm.premium} onChange={e => setInsuranceForm({ ...insuranceForm, premium: e.target.value })} />
                                    </div>
                                </div>
                                <div className='flex gap-4 mt-8'>
                                    <button type='button' onClick={() => setShowInsuranceModal(false)} className='flex-1 py-3 bg-slate-100 dark:bg-gray-800 text-slate-600 dark:text-slate-300 font-bold rounded-xl'>Cancel</button>
                                    <button type='submit' className='flex-1 py-3 bg-gradient-to-r from-cyan-600 to-sky-700 text-white font-bold rounded-xl shadow-md'>
